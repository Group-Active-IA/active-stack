...
public static class UiStrings
{
    ...
    private static readonly Dictionary<string, string> En = new()
    {
        ...
        ["page.dependencies.title"] = "System dependencies",
        ["page.dependencies.subtitle"] = "Here's what Active Stack found on this machine. Nothing is installed automatically.",
        ["dependencies.status.installed"] = "Installed",
        ["dependencies.status.missing"] = "Not found",
        ["dependencies.label.required"] = "Required",
        ["dependencies.label.optional"] = "Optional",
        ["dependencies.label.run"] = "Run:",
        ...
        ["complete.state.error.title.install"] = "Installation failed",
        ["complete.state.error.title.uninstall"] = "Uninstallation failed",
        ["complete.state.error.title.starter"] = "Starter installation failed",
    ...
    private static readonly Dictionary<string, string> Es = new()
    {
        ...
        ["page.dependencies.title"] = "Dependencias del sistema",
        ["page.dependencies.subtitle"] = "Esto es lo que Active Stack encontró en esta máquina. No se instala nada automáticamente.",
        ["dependencies.status.installed"] = "Instalado",
        ["dependencies.status.missing"] = "No encontrado",
        ["dependencies.label.required"] = "Requerido",
        ["dependencies.label.optional"] = "Opcional",
        ["dependencies.label.run"] = "Ejecutá:",
        ...
        ["complete.state.error.title.install"] = "La instalación falló",
        ["complete.state.error.title.uninstall"] = "La desinstalación falló",
        ["complete.state.error.title.starter"] = "La instalación del starter falló",
